...
export default function LandingPage({ onSelectClass, language, setLanguage }: { onSelectClass: (c: string) => void, language: Language, setLanguage: (l: Language) => void }) {
  const classes = [
    { id: '8', name: 'Class 8', active: false },
    { id: '9', name: 'Class 9', active: false },
    { id: '10', name: 'Class 10 (SSLC)', active: true },
    { id: '11', name: 'Class 11 (+1)', active: true },
    { id: '12', name: 'Class 12 (+2)', active: false },
  ];
